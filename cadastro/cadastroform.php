              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="POST" action="cadastro/cadastro.php">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-danger"><a class="text-decoration-none text-white" href="../login/loginform.php">Fazer Login</a></button>
                  </div>
                </form>
