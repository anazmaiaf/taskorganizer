<?php
    ...
    $result->execute();
    $projetos = $result->fetch(PDO::FETCH_ASSOC);
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="form-outline">
                                ...
                                <input name="projeto" class="form-control" placeholder="Projeto" value="<?php echo $projetos['nomeprojeto']?>"/>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                                ...
                                <input name="inicio" type="date" class="form-control" placeholder="Início" value="<?php echo $projetos['data_inicio']?>"/>
                            </div>
                            <!-- Status -->
                            <div class="form-outline mt-4">
                                <label class="form-label" for="status">Status</label>
                                <select class="form-select" name="status">
                                    <option selected disabled><?php echo $projetos['status']?></option>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                                ...
                                <input name="entrega" type="date" class="form-control" placeholder="Entrega" value="<?php echo $projetos['data_entrega']?>"/>
                            </div>
                            <!-- Andamento -->
                            <div class="form-outline mt-4">
                                <label class="form-label" for="andamento">Andamento</label>
                                <select class="form-select" name="andamento">
                                    <option selected disabled><?php echo $projetos['andamento']?></option>
